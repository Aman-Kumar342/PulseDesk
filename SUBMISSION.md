...
- [x] Must features: orgs, 3 roles, tickets, threaded replies, filter/search, JSON API, seeder
- [x] Multi-tenant isolation + cross-tenant feature test (8 tests passing)
- [x] 2 sprint docs (sprints/sprint-0N.md)
- [ ] Real Hermes -> OpenClaw handoff in Slack (slack-export/)
- [ ] >=1 human-merged PR
- [x] CI green on Actions tab
